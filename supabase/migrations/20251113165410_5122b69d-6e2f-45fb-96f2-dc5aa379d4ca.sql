-- Fix delete_user_account function to handle assigned_by foreign key constraint
...
BEGIN
  ...
  -- 6. NOUVEAU: Mettre assigned_by à NULL pour les catégories assignées par cet utilisateur
  UPDATE seller_authorized_categories
  SET assigned_by = NULL
  WHERE assigned_by = target_user_id;
  
  -- 7. Supprimer les autorisations de catégories
